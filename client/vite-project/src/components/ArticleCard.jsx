...
export default function ArticleCard({ article }) {
  return (
    <article className="bg-white rounded-2xl overflow-hidden border border-stone-200/70 hover:border-stone-300 transition-all flex flex-col h-full shadow-sm">
      {/* Top Image */}
      ...
      <div className="p-5 flex flex-col flex-grow justify-between space-y-4">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-[11px] font-bold tracking-wider uppercase text-[#C26D2B]">
            ...
            <span className="text-stone-400 font-normal lowercase">{article.readTime}</span>
          </div>
